...
#step2.크롤링할 url 주소를 입력한다. (네이버에서 사건사고 검색 후, 뉴스 탭 클릭하였음)
#url = 'https://search.naver.com/search.naver?where=news&sm=tab_jum&query=사건사고'

#step2-1.만약 키워드를 매번 다르게 입력하고 싶다면 아래와 같이 구성하기.
